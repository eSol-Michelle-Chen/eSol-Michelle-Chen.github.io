!(function (e) {
    ...
    AFRAME.registerComponent("particle-system", {
      schema: {
        ...
        texture: {
          type: "asset",
          default:
            "https://cdn.rawgit.com/IdeaSpaceVR/aframe-particle-system-component/master/dist/images/star2.png",
        },
      ...
      init: function () {
        (this.presets = {}),
          (this.presets.dust = {
            ...
            particleCount: 100,
            texture:
              "https://cdn.rawgit.com/IdeaSpaceVR/aframe-particle-system-component/master/dist/images/smokeparticle.png",
          }),
          (this.presets.dust = {
            maxAge: 20,
            positionSpread: { x: 100, y: 100, z: 100 },
          ...
          (this.presets.rain = {
            ...
            size: 0.4,
            texture:
              "https://cdn.rawgit.com/IdeaSpaceVR/aframe-particle-system-component/master/dist/images/raindrop.png",
          });
      },
      update: function (e) {
      ...
      applyPreset: function (e) {
        return !this.attrValue[e] && this.preset[e]
          ? this.preset[e]
          : this.data[e];
      },
      tick: function (e, t) {
      ...
      initParticleSystem: function (e) {
        ...
        this.particleGroup = new i.Group({
          texture: { value: r },
          maxParticleCount: e.maxParticleCount,
          blending: e.blending,
        });
        var a = new i.Emitter({
          ...
          acceleration: {
            value: new THREE.Vector3(
              e.accelerationValue.x,
              e.accelerationValue.y,
              e.accelerationValue.z
            ),
            spread: new THREE.Vector3(
              e.accelerationSpread.x,
              e.accelerationSpread.y,
              e.accelerationSpread.z
            ),
          },
          velocity: {
            value: new THREE.Vector3(
        ...
        this.particleGroup.addEmitter(a),
  ...
  function (e, t, r) {
    var i,
      a,
      o = {
        distributions: { BOX: 1, SPHERE: 2, DISC: 3, LINE: 4 },
    ...
    (i = o),
      ...
      (o.TypedArrayHelper.prototype.splice = function (e, t) {
        ...
        for (var r = [], i = this.array, a = i.length, o = 0; o < a; ++o)
          (o < e || o >= t) && r.push(i[o]);
      ...
      (o.TypedArrayHelper.prototype.setVec4Components = function (
        e,
        t,
        r,
        i,
      ...
      (o.ShaderAttribute.prototype._ensureTypedArray = function (e) {
        ...
        (null !== this.typedArray &&
          ...
          (null !== this.typedArray && this.typedArray.size !== e
            ...
            : null === this.typedArray &&
              (this.typedArray = new o.TypedArrayHelper(
                this.arrayType,
                e,
                this.componentSize
              )));
        ...
        return (
          ...
          null !== this.bufferAttribute
            ...
            : ((this.bufferAttribute = new THREE.BufferAttribute(
              ...
              void (this.bufferAttribute.usage = this.dynamicBuffer
                ? THREE.DynamicDrawUsage
                : THREE.StaticDrawUsage))
        );
      }),
      ...
      (o.utils = {
        ...
        ensureArrayInstanceOf: function (e, t, r) {
          ...
          if (Array.isArray(e)) {
            for (var i = e.length - 1; i >= 0; --i)
              if (void 0 !== t && e[i] instanceof t == !1) return r;
            return e;
          }
        ...
        ensureValueOverLifetimeCompliance: function (e, t, r) {
          ...
          (t = t || 3),
            (r = r || 3),
            Array.isArray(e._value) === !1 && (e._value = [e._value]),
            Array.isArray(e._spread) === !1 && (e._spread = [e._spread]);
          var i = this.clamp(e._value.length, t, r),
            a = this.clamp(e._spread.length, t, r),
            o = Math.max(i, a);
          e._value.length !== o &&
            (e._value = this.interpolateArray(e._value, o)),
            e._spread.length !== o &&
              (e._spread = this.interpolateArray(e._spread, o));
        },
        interpolateArray: function (e, t) {
          "use strict";
          for (
            var r = e.length,
              i = ["function" == typeof e[0].clone ? e[0].clone() : e[0]],
              a = (r - 1) / (t - 1),
              o = 1;
            o < t - 1;
            ++o
          ...
          return (
            i.push(
              "function" == typeof e[r - 1].clone ? e[r - 1].clone() : e[r - 1]
            ),
            i
          );
        },
        ...
        zeroToEpsilon: function (e, t) {
          ...
          var r = 1e-5,
            i = e;
          return (
            (i = t ? Math.random() * r * 10 : r), e < 0 && e > -r && (i = -i), i
          );
        },
        lerpTypeAgnostic: function (e, t, r) {
          ...
          return typeof e === a.NUMBER && typeof t === a.NUMBER
            ...
            ? ((i = e.clone()),
              (i.x = this.lerp(e.x, t.x, r)),
              (i.y = this.lerp(e.y, t.y, r)),
              i)
            : e instanceof THREE.Vector3 && t instanceof THREE.Vector3
            ? ((i = e.clone()),
              (i.x = this.lerp(e.x, t.x, r)),
              (i.y = this.lerp(e.y, t.y, r)),
              (i.z = this.lerp(e.z, t.z, r)),
              i)
            ...
            ? ((i = e.clone()),
              ...
              (i.y = this.lerp(e.y, t.y, r)),
              (i.z = this.lerp(e.z, t.z, r)),
              (i.w = this.lerp(e.w, t.w, r)),
              i)
            : e instanceof THREE.Color && t instanceof THREE.Color
            ? ((i = e.clone()),
              (i.r = this.lerp(e.r, t.r, r)),
              (i.g = this.lerp(e.g, t.g, r)),
              (i.b = this.lerp(e.b, t.b, r)),
              i)
            : void console.warn(
        ...
        randomVector3: function (e, t, r, i, a) {
          ...
          a &&
            ((o = 0.5 * -a.x + this.roundToNearestMultiple(o, a.x)),
            (s = 0.5 * -a.y + this.roundToNearestMultiple(s, a.y)),
            (n = 0.5 * -a.z + this.roundToNearestMultiple(n, a.z))),
            e.typedArray.setVec3Components(t, o, s, n);
        },
        randomColor: function (e, t, r, i) {
          ...
          (a = this.clamp(a, 0, 1)),
            (o = this.clamp(o, 0, 1)),
            (s = this.clamp(s, 0, 1)),
            e.typedArray.setVec3Components(t, a, o, s);
        },
        ...
        randomVector3OnLine: function (e, t, r, i) {
          "use strict";
          var a = r.clone();
          a.lerp(i, Math.random()),
            e.typedArray.setVec3Components(t, a.x, a.y, a.z);
        },
        randomVector3OnSphere: function (e, t, r, i, a, o, s, n) {
          ...
          s && (c = Math.round(c / s) * s),
            ...
            (h += r.y),
            (y += r.z),
            e.typedArray.setVec3Components(t, d, h, y);
        },
        ...
        randomVector3OnDisc: function (e, t, r, i, a, o, s) {
          ...
          s && (u = Math.round(u / s) * s),
            ...
            (p += r.y),
            (c += r.z),
            e.typedArray.setVec3Components(t, l, p, c);
        },
        randomDirectionVector3OnSphere: (function () {
          ...
          return function (t, r, i, a, o, s, n, u) {
            e.copy(s),
              ...
              (e.y -= a),
              (e.z -= o),
              e.normalize().multiplyScalar(-this.randomFloat(n, u)),
              t.typedArray.setVec3Components(r, e.x, e.y, e.z);
          };
        })(),
        randomDirectionVector3OnDisc: (function () {
          ...
          return function (t, r, i, a, o, s, n, u) {
            e.copy(s),
              ...
              (e.z -= o),
              e.normalize().multiplyScalar(-this.randomFloat(n, u)),
              t.typedArray.setVec3Components(r, e.x, e.y, 0);
          };
        })(),
      ...
      (o.Group = function (e) {
        ...
        (e = t.ensureTypedArg(e, r.OBJECT, {})),
          ...
          (this.fixedTimeStep = t.ensureTypedArg(
            e.fixedTimeStep,
            r.NUMBER,
            0.016
          )),
          (this.texture = t.ensureInstanceOf(
            e.texture.value,
            THREE.Texture,
            null
          )),
          (this.textureFrames = t.ensureInstanceOf(
            e.texture.frames,
            THREE.Vector2,
            new THREE.Vector2(1, 1)
          )),
          (this.textureFrameCount = t.ensureTypedArg(
          ...
          (this.hasPerspective = t.ensureTypedArg(
            e.hasPerspective,
            r.BOOLEAN,
            !0
          )),
          (this.colorize = t.ensureTypedArg(e.colorize, r.BOOLEAN, !0)),
          (this.maxParticleCount = t.ensureTypedArg(
            e.maxParticleCount,
            r.NUMBER,
            null
          )),
          (this.blending = t.ensureTypedArg(
            e.blending,
            r.NUMBER,
            THREE.AdditiveBlending
          )),
          ...
          (this.alphaTest = parseFloat(
            t.ensureTypedArg(e.alphaTest, r.NUMBER, 0)
          )),
      ...
      (o.Group.prototype.removeEmitter = function (e) {
        ...
        for (var n in this.attributes)
          this.attributes.hasOwnProperty(n) && this.attributes[n].splice(r, i);
      ...
      (o.Group.prototype.releaseIntoPool = function (e) {
        "use strict";
        return e instanceof o.Emitter == !1
          ? void console.error("Argument is not instanceof SPE.Emitter:", e)
          : (e.reset(), this._pool.unshift(e), this);
      }),
      ...
      (o.Group.prototype.addPool = function (e, t, r) {
        ...
        for (var a = 0; a < e; ++a)
          (i = Array.isArray(t) ? new o.Emitter(t[a]) : new o.Emitter(t)),
            this.addEmitter(i),
            this.releaseIntoPool(i);
        return this;
      }),
      ...
      (o.Group.prototype.triggerPoolEmitter = function (e, t) {
        ...
        if ("number" == typeof e && e > 1)
          for (var r = 0; r < e; ++r) this._triggerSingleEmitter(t);
      ...
      (o.Group.prototype.tick = function (e) {
        ...
        if (
          ...
          for (var n, t = 0; t < i; ++t)
            (n = r[t]), n.tick(a), this._updateBuffers(n);
      ...
      (o.Emitter = function (e) {
        ...
        (e = t.ensureTypedArg(e, r.OBJECT, {})),
          ...
          (this.position = {
            _value: t.ensureInstanceOf(
              e.position.value,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _spread: t.ensureInstanceOf(
              e.position.spread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _spreadClamp: t.ensureInstanceOf(
              e.position.spreadClamp,
              THREE.Vector3,
              new THREE.Vector3()
            ),
            _distribution: t.ensureTypedArg(
            ...
            _radiusScale: t.ensureInstanceOf(
              e.position.radiusScale,
              THREE.Vector3,
              new THREE.Vector3(1, 1, 1)
            ),
            _distributionClamp: t.ensureTypedArg(
          ...
          (this.rotation = {
            _axis: t.ensureInstanceOf(
              e.rotation.axis,
              THREE.Vector3,
              new THREE.Vector3(0, 1, 0)
            ),
            _axisSpread: t.ensureInstanceOf(
          ...
          (this.color = {
            _value: t.ensureArrayInstanceOf(
              e.color.value,
              THREE.Color,
              new THREE.Color()
            ),
            _spread: t.ensureArrayInstanceOf(
              e.color.spread,
              THREE.Vector3,
              new THREE.Vector3()
            ),
          ...
          (this.particleCount = t.ensureTypedArg(
            e.particleCount,
            r.NUMBER,
            100
          )),
          ...
          (this.activeMultiplier = t.ensureTypedArg(
            e.activeMultiplier,
            r.NUMBER,
            1
          )),
          ...
          (this.resetFlags = {
            position:
              t.ensureTypedArg(e.position.randomise, r.BOOLEAN, !1) ||
              t.ensureTypedArg(e.radius.randomise, r.BOOLEAN, !1),
            velocity: t.ensureTypedArg(e.velocity.randomise, r.BOOLEAN, !1),
            acceleration:
              t.ensureTypedArg(e.acceleration.randomise, r.BOOLEAN, !1) ||
              t.ensureTypedArg(e.drag.randomise, r.BOOLEAN, !1),
            rotation: t.ensureTypedArg(e.rotation.randomise, r.BOOLEAN, !1),
            rotationCenter: t.ensureTypedArg(
        ...
        for (var a in this.updateMap)
          this.updateMap.hasOwnProperty(a) &&
            ((this.updateCounts[this.updateMap[a]] = 0),
            (this.updateFlags[this.updateMap[a]] = !1),
            this._createGetterSetters(this[a], a));
            ...
            Object.defineProperty(e, a, {
              ...
              set: (function (e) {
                return function (i) {
                  ...
                  "_rotationCenter" === e
                    ? ((r.updateFlags.rotationCenter = !0),
                      (r.updateCounts.rotationCenter = 0))
                    : "_randomise" === e
                    ? (r.resetFlags[a] = i)
                    : ((r.updateFlags[a] = !0), (r.updateCounts[a] = 0)),
                    r.group._updateDefines(),
                    (this[e] = i),
                    Array.isArray(s) &&
                      o.utils.ensureValueOverLifetimeCompliance(r[t], n, n);
                };
              })(i),
            });
          }
      ...
      (o.Emitter.prototype._assignForceValue = function (e, t) {
        ...
        switch (h) {
          ...
          case u.SPHERE:
            (r = this.attributes.position.typedArray.array),
              ...
              (a = r[n + 1]),
              (s = r[n + 2]),
              l.randomDirectionVector3OnSphere(
                this.attributes[t],
                e,
                i,
                a,
          ...
          case u.DISC:
            (r = this.attributes.position.typedArray.array),
              ...
              (a = r[n + 1]),
              (s = r[n + 2]),
              l.randomDirectionVector3OnDisc(
                this.attributes[t],
                e,
                i,
                a,
        ...
        if ("acceleration" === t) {
          var y = l.clamp(
            l.randomFloat(this.drag._value, this.drag._spread),
            0,
            1
          );
      ...
      (o.Emitter.prototype._assignAbsLifetimeValue = function (e, t) {
        ...
        s.arrayValuesAreEqual(a._value) && s.arrayValuesAreEqual(a._spread)
          ? ((r = Math.abs(s.randomFloat(a._value[0], a._spread[0]))),
            i.setVec4Components(e, r, r, r, r))
          : i.setVec4Components(
              e,
      ...
      (o.Emitter.prototype._assignAngleValue = function (e) {
        ...
        a.arrayValuesAreEqual(i._value) && a.arrayValuesAreEqual(i._spread)
          ? ((t = a.randomFloat(i._value[0], i._spread[0])),
            r.setVec4Components(e, t, t, t, t))
          : r.setVec4Components(
              e,
              a.randomFloat(i._value[0], i._spread[0]),
              a.randomFloat(i._value[1], i._spread[1]),
              a.randomFloat(i._value[2], i._spread[2]),
              a.randomFloat(i._value[3], i._spread[3])
            );
      }),
      (o.Emitter.prototype._assignParamsValue = function (e) {
        ...
        this.attributes.params.typedArray.setVec4Components(
          ...
          0,
          Math.abs(
            o.utils.randomFloat(this.maxAge._value, this.maxAge._spread)
          ),
          o.utils.randomFloat(this.wiggle._value, this.wiggle._spread)
        );
      }),
      ...
      (o.Emitter.prototype._resetBufferRanges = function () {
        ...
        for (i; i >= 0; --i)
          (e = r[i]),
            (t[e].min = Number.POSITIVE_INFINITY),
        ...
        for (var a, o, s, n, u = t - 1; u >= e; --u)
          (a = 4 * u),
            ...
            0 !== n &&
              ...
              1 === this.direction
                ? ((s += i),
                  s >= o && ((s = 0), (n = 0), this._decrementParticleCount()))
                : ((s -= i),
                  s <= 0 && ((s = o), (n = 0), this._decrementParticleCount())),
              (r[a] = n),
              (r[a + 1] = s),
        ...
        for (var a, o, s = this.direction, n = e; n < t; ++n)
          (a = 4 * n),
            (0 != r[a] && 1 !== this.particleCount) ||
              ...
              (r[a] = 1),
              this._resetParticle(n),
              (o = i * (n - e)),
              (r[a + 1] = s === -1 ? r[a + 2] - o : o),
              this._updateAttributeUpdateRange("params", n));
      }),
      (o.Emitter.prototype.tick = function (e) {
        ...
        if (!this.isStatic) {
          ...
          if (
            (this._resetBufferRanges(),
            this._checkParticleAges(t, r, i, e),
            this.alive === !1)
          )
          ...
          var s = 1 === this.particleCount ? o : 0 | o,
            ...
            l = u > 0 ? e / u : 0;
          this._activateParticles(s, n, i, l),
            (this.activationIndex += a),
            this.activationIndex > r && (this.activationIndex = t),
            (this.age += e);
        }
      }),
      (o.Emitter.prototype.reset = function (e) {
        ...
        if (((this.age = 0), (this.alive = !1), e === !0)) {
          for (
            var t,
              r = this.attributeOffset,
              i = r + this.particleCount,
              a = this.paramsArray,
              o = this.attributes.params.bufferAttribute,
              s = i - 1;
            s >= r;
            --s
          )
            (t = 4 * s), (a[t] = 0), (a[t + 1] = 0);
          (o.updateRange.offset = 0),
